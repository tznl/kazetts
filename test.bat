...
cl /MD %CFLAGS% %INC% %IN% /Fo%BDIR%test.obj
...
cl /MD /nologo /Fe%BDIR%\run.exe %BDIR%\test.obj %BDIR%\miniaudio.obj ^
    /link /SUBSYSTEM:CONSOLE /INCLUDE:piper_create^
...
copy thirdparty\piper1-gpl\libpiper.dll %BDIR%
